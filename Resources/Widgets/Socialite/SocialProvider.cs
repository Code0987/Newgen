...
namespace Social.Base
{
    ...
    {
        private const string AppId = "137822596336265";
        ...
        public SocialProvider()
        {
            try
            {
                this.oauthResult = FacebookOAuthResult.Parse(Widget.Settings.AuthData);
            }
            catch
            {
        ...
        {
            Widget.Settings.AuthData = e.Url.OriginalString;
