...
namespace Newgen {
    ...
    public static class Api {
        ...
        public static readonly string Newgen_Api_Author = "Newgen, NS";
        public static readonly string Newgen_Api_AuthorEMailFormat = "Newgen+Support+{0}@nsapps.net";
        public static readonly string Newgen_Api_AuthorWebsiteUriFormat = string.Format("{0}/Apps/NewgenStore?Package=", WebShared.MainSiteUri) + "{0}";

        public static Newgen.Packages.PackageMetadata CreateMetadataFor(Type packageType, string packageId, string description = "Newgen package.") {
            return new PackageMetadata() {
                Id = packageId,

                Version = packageType.Assembly.GetTimestamp(),
                License = string.Format("© 2014 NS, {0} for Newgen", packageId),
                Name = packageId,
                Description = description,

                Author = Newgen_Api_Author,
                AuthorEMailAddress = string.Format(Newgen_Api_AuthorEMailFormat, packageId),
                AuthorWebsite = string.Format(Newgen_Api_AuthorWebsiteUriFormat, packageId)
            };
        }
